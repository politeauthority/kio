...
from kio_server.utils import date_utils
from kio_server.utils import glow
from kio_server.utils import xlate
...
class Base:
    ...
    def _establish_db(self, conn, cursor) -> bool:
        """Creates the database connection, based on either arguments passed in to the model or the
        global vars already set if they exist.
        """
        self.conn = conn
...
# End File: kio/kio-server/modules/models/base.py
