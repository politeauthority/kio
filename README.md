...
### Kio Server
The Kio Server portion of the project consists of a containerized web app to manage multiple
Kio-Nodes and send commands to them to manage their displays. For more details on Kio-Node
such as documentation and install guides check out the Kio-Server [READEME.md](kio-server/README.md)
